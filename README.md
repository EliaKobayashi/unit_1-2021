...
| Test if the validation function works.                                                                                                                                                                            | Unit Testing        | 1. Initiate the program.  2. When asked to input 1 or 2, input 3.                                                                                                    | As the input was not 1 or 2, it prints "Wrong input." and the same message will print again.                                                                                                                                                                                                                                                                                                   | Figure 6.                                                                                                                                                                                                             |
...
| Reviews if the code has adequate comments, function name, and variable name.                                                                                                                                      | Code Review         | As this is a review, there are no inputs.                                                                                                                            | The code will contain comments to detail how the code works. Names of functions and variables will be adequate to eliminate confusing.                                                                                                                                                                                                                                                         | This can be seen in Figure 7. where the introduction of the game is shown.                                                                                                                                            |
